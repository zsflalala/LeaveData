...
# 解析页面
def parse_motor_page(pro_name,page_url,headers,typeName):
    pro_dic = {}
...
def TorquMotor(headers,filename='torqu_motor.json',typeName='力矩电机'):
    final_dic = []
    ...
    for index in range(length):
        ...
        pro_name,pro_dic = parse_motor_page(pro_name=pro_name,page_url=pro_urls[index],headers=headers,typeName=typeName)
...
if __name__ == '__main__':
    ...
    final_dic['pro'] = TorquMotor(headers=headers)
    filename='力矩电机.json'
